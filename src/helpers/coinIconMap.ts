/*
 *const curr = ["btc","eth ","aave","ada","bch","bnb","bsv","cro","dot","eos","link","ltc","mkr","neo","snx","theta","trx","usdc","usdt","vet","wbtc","xem","xmr","xrp","xtz","xlm","miota","dash","btg","omg","qtum","zec","etc","zrx","ae","bts","dcr","dgb","icx","ont","zil","atom","dai","doge","leo","rep","steem","uni","cel","busd","comp","fil","ftt","ht","sushi","yfi","logomark"];
 *
 *type CoinIconMapType = {
 *  [key: string]: string;
 *}
 *
 *let coinIconMap: CoinIconMapType = {
 *  YFI: "",
 *  SUSHI: "",
 *  HT: "",
 *  FTT: "",
 ...
 *  let url ="https: //api.coincap.io/v2/assets/icons/" + curr[i] + "@2x.png";
 *  const res = await fetch(url);
 *  const imageBlob = await res.blob();
 *  const imageObjectURL = URL.createObjectURL(imageBlob);
 *  coinIconMap[curr[i].toUpperCase()] = imageObjectURL;
 *}
 *
